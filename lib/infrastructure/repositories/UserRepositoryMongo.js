...
module.exports = class extends UserRepository {
    ...
    async persist(userEntity) {
        ...
        return new User(mongooseUser.id, mongooseUser.firstName, mongooseUser.lastName, mongooseUser.address, mongooseUser.phone, mongooseUser.email, mongooseUser.password);
    }
